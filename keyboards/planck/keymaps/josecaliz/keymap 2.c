...
[_DVORAK] = LAYOUT_planck_grid(
  ...
  KC_LCTL, KC_GRV, KC_LALT, KC_LGUI, MO(1), KC_SPC, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
...
[_LRAISE] = LAYOUT_planck_grid(
  ...
  KC_TRNS, LGUI(KC_W), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3), KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

[_RRAISE] = LAYOUT_planck_grid(
